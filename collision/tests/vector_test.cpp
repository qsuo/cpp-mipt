...
{
    space::Vector3d vector1({1, 1, 1});
    space::Vector3d vector2({2, 2, 2});
    space::Vector3d addVector({3, 3, 3});
...
{
    space::Vector3d vector1({1, 1, 1});
    space::Vector3d vector2({4, 4, 4});
    space::Vector3d subVector({3, 3, 3});
...
{
    space::Vector3d vector({1, 1, 1});
    const double factor = 3;
    space::Vector3d mulVector({3, 3, 3});
...
{
    space::Vector3d vector1({1, 2, 3});
    space::Vector3d vector2({4, 5, 6});
...
TEST(Vector, crossProduct)
{
    space::Vector3d vector1({1, 2, 3});
    space::Vector3d vector2({4, 5, 6});
    space::Vector3d realProduct({2 * 6 - 3 * 5, 3 * 4 - 1 * 6, 1 * 5 - 2 * 4});
    auto product = crossProduct(vector1, vector2);
