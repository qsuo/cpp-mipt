...
bool pointInsideTriangle(const space::dim2::Vector &point, const space::dim2::Triangle &triangle)
{
...
namespace dim2
{
bool intersection(const Triangle &pfirst, const Triangle &psecond)
{
